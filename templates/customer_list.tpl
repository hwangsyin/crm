...
<div class="customer-list" id="customer-list">
    {% if customer_list %}
        ...
        <div class="customer" id="{{customer.id}}" data-href="/customers/{{ customer.id }}" onmouseover="onMouseOverCustomer(this)" onmouseout="onMouseOutCustomer(this)" onclick="onClickCustomer(this)">
