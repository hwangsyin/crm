...
db.customer.insert({id: NumberLong("1"), title: "李先生", 
...
db.customer.insert({id: NumberLong("2"), title: "余先生", 
...
db.customer.insert({id: NumberLong("3"), title: "陆小姐", 
    phone_number: [{number: "18610231128"}, {number: "18610231129"}], 
    name: "陆思凝", email: "sheila@gmail.com", age: 34, 
    address: "香港九龙", start_time: new Date(), end_time: null});

db.customer.insert({id: NumberLong("4"), title: "沈小姐", 
